      ...
      <DndContext onDragEnd={handleDragEnd}>
        <div className="h-screen overflow-hidden flex flex-row">
          <div className="flex-1 h-screen overflow-hidden flex flex-row bg-white border-t border-r border-gray-200 rounded-tr-xl mr-2">
            <Sidebar selectedSprite={selectedSprite} setSelectedSprite={setSelectedSprite} setCount={setCount} count={count} setItems={setItems} setreset={setreset} />
          ...
          <div className="w-1/2 h-screen overflow-hidden flex flex-row bg-white border-t border-l border-gray-200 rounded-tl-xl ml-2">
            <PreviewArea items={items} //styles={styles} sstyles={sstyles} 
            reset={reset}
            count={count}/>
